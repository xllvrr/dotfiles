...
D'aḹtra parte si può anche usare, adattandolo alle proprie esigenze, il metodo indicato nella pagina~\pageref{proc:titlepage}, dove la tabella dei relatori e correlatori è composta “a mano”; per esempio, se si volesse indicare una lista di correlatori senza l'opzione \chiave{stile}{classica}, oppure se si volesse aumentare il numero dei relatori oltre il tre, basta inserire la tabella al posto dell'argomento del secondo o del terzo componente della lista, in questo modo (senza l'opzione \chiave{stile}{classica}):
\begin{verbatim}
...
\def\V{\rule{0pt}{2.5ex}}\tabcolsep=4pt
